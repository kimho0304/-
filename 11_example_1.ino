...
#define _DUTY_MAX 2660 // servo full counterclockwise position (180 degree)
...
void loop() {
  ...
  if(dist_raw <= _TARGET_LOW){
    ...
    int tmp = ((dist_raw-180.0)/(180.0))*(_DUTY_MAX-_DUTY_MIN);
  ...
  //Serial.print(", tmp:");  Serial.print(tmp2);
